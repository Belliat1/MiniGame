...
function moverpersonaje(e)
{
	...
	{
		case teclas.LEFT:
			xpersonaje = xpersonaje - movimiento;
			dibujar(xpersonaje, ypersonaje);
		break;
		case teclas.UP:
			ypersonaje = ypersonaje - movimiento;
			dibujar(xpersonaje, ypersonaje);
		break;
		case teclas.RIGHT:
			xpersonaje = xpersonaje + movimiento;
...
personaje.imagen.addEventListener("load", cargapersonaje);
...
function dibujar()
{
	...
	if(personaje.carga)
	{
		papel.drawImage(personaje.imagen, xpersonaje, ypersonaje)
	}
}
